...
<div>
    ...
    <a href="{{url('admin/operator/siswa')}}" class="btn btn-secondary"><< Kembali</a>
    @endif
    @if (Auth::user()->role == 'guru_bk')
    <a href="{{url('admin/guru_bk/siswa')}}" class="btn btn-secondary"><< Kembali</a>
    @endif
    @if (Auth::user()->role == 'wali_kelas')
    <a href="{{url('admin/wali_kelas/siswa')}}" class="btn btn-secondary"><< Kembali</a>
    @endif
    </div>
<form action='{{ url('siswa')}}' method='post'>
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='tmp_lahir' value="{{Session::get('tmp_lahir')}}" id="tmp_lahir">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name='nohp_ortu' value="{{Session::get('nohp_ortu')}}" id="nohp_ortu">
            </div>
        </div>
