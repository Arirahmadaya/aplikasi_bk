...
<section class="content-header">
    ...
    <div class="pb-3">
      <a href="{{url('')}}/admin/operator/create_operator" class="btn btn2 btn-primary fw-bold">+ Tambah Data</a>
    </div>
  </div><!-- /.container-fluid -->
  </section>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="d-flex align-items-center">
            <a href="{{url('operator/'.$item->id.'/edit')}}" class="btn btn-warning btn-sm mr-1">
                <i class="bi bi-pencil"></i>Edit
             </a>
             <form  class='d-inline' action="{{url('operator/'.$item->id)}}" method="post">
              @csrf
              @method('DELETE')
